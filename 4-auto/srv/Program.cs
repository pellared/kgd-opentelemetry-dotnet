// Example usage:
//     OTEL_SERVICE_NAME=srv OTEL_DOTNET_AUTO_METRICS_ADDITIONAL_SOURCES="MyCompany.MyWebService" OTEL_DOTNET_AUTO_METRICS_ADDITIONAL_SOURCES="MyCompany.MyWebService" dotnet run
